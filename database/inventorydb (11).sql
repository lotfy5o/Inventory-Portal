...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 17, 2023 at 10:41 PM
...
(4, 3, 1, 33, 1, 15, 17, 3),
(5, 4, 1, 111, 1, 15, 18, 3),
(6, 5, 1, 111, 22, 15, 18, 4),
(7, 5, 1, 11112, 2, 15, 16, 6),
(8, 9, 1, 100, 1, 14, 25, 6),
(10, 10, 1, 100, 1, 14, 25, 6),
(11, 10, 1, 100, 12, 15, 17, 6);
...
(1, 1, 1, 9, NULL, NULL, NULL),
(2, 1, 1, 10, NULL, NULL, NULL),
(3, 1, 12, 10, NULL, NULL, NULL);
...
--
ALTER TABLE `purchaseinvoice`
  MODIFY `pur_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `purchaseinvoicedetails`
--
ALTER TABLE `purchaseinvoicedetails`
  MODIFY `pid_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `stock`
  MODIFY `sto_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 17, 2023 at 11:57 PM
...
INSERT INTO `productprice` (`pp_id`, `pp_proID`, `pp_price`, `pp_catID`, `pp_sizeID`, `pp_colID`) VALUES
(3, 1, 100, 15, 16, 3),
(4, 1, 100, 15, 18, 6);
...
INSERT INTO `purchaseinvoicedetails` (`pid_id`, `pid_purID`, `pid_proID`, `pid_perPiecePrice`, `pid_quantity`, `pid_catID`, `pid_sizeID`, `pid_colID`) VALUES
(15, 14, 1, 100, 1, 15, 16, 3),
(16, 14, 1, 100, 1, 15, 18, 6);
...
INSERT INTO `stock` (`sto_id`, `sto_proID`, `sto_quan`, `sto_purID`, `sto_catID`, `sto_sizeID`, `sto_colID`) VALUES
(6, 1, 1, 14, 15, 16, 3),
(7, 1, 1, 14, 15, 18, 6);

...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 22, 2023 at 02:54 PM
...
(4, 'lotfy', '0101111111', '10th of ramadan'),
(5, 'menna', '0101111111', '10th of ramadan');
...
--
ALTER TABLE `sizes`
  MODIFY `si_id` tinyint(4) NOT NULL AUTO_INCREMENT;
